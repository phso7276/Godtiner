...
class JwtServiceTest {
    ...
    public void init(){
        ...
        Member member = Member.builder().email(username).password("1234567890").name("Member1").nickname("NickName1").build();
    ...
    public void updateRefreshToken_refreshToken_업데이트() throws Exception {
        ...
        assertThat(memberRepository.findByRefreshToken(reIssuedRefreshToken).get().getEmail()).isEqualTo(username);
    }
